              ...
              <form role="form" method = "POST" action= "<?= $action_url ?>" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group ">
                    ...
                    <textarea type="text" class="form-control" id="address" name=address placeholder="Enter Address"><?php echo $address ?></textarea>
                  </div>

                  <div class="form-group ">
                    <label for="price">Date of Birth<span class="error">*</span><span id="dobErr" class="error"></span></label>
                    <input type="text" class="form-control datepicker" id="dob" name=dob placeholder="Enter Date of Birth" value="<?php echo $dob ?>" readonly>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control"  name="image_old" value="<?= $image ?>"  placeholder="Password">
                    <div><small><strong>Note:</strong> Only jpg, png, jpeg file type allowed.</small></div>
                   
                    <?php if($button == 'Edit' ) { ?>

                    <img src="<?= base_url() ?>uploads/employees/thumbnail/<?= $imagethumb ?>">
                    <?php } ?>
